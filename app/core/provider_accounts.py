...
class ProviderAccountErrorCode(StrEnum):
    ...
    QOBUZ_AUTH_INVALID_FORMAT = "QOBUZ_AUTH_INVALID_FORMAT"
    QOBUZ_AUTH_INVALID_CREDENTIALS = "QOBUZ_AUTH_INVALID_CREDENTIALS"
    QOBUZ_AUTH_NETWORK_ERROR = "QOBUZ_AUTH_NETWORK_ERROR"
    QOBUZ_AUTH_SESSION_INVALID = "QOBUZ_AUTH_SESSION_INVALID"
    QOBUZ_AUTH_SUBSCRIPTION_REQUIRED = "QOBUZ_AUTH_SUBSCRIPTION_REQUIRED"
    QOBUZ_AUTH_PERSIST_FAILED = "QOBUZ_AUTH_PERSIST_FAILED"
    QOBUZ_AUTH_RELOAD_FAILED = "QOBUZ_AUTH_RELOAD_FAILED"
    QOBUZ_AUTH_MESSAGE_DELETE_FAILED = "QOBUZ_AUTH_MESSAGE_DELETE_FAILED"
    APPLE_MUSIC_AUTH_INVALID_FORMAT = "APPLE_MUSIC_AUTH_INVALID_FORMAT"
    APPLE_MUSIC_AUTH_SESSION_INVALID = "APPLE_MUSIC_AUTH_SESSION_INVALID"
    APPLE_MUSIC_AUTH_SUBSCRIPTION_REQUIRED = "APPLE_MUSIC_AUTH_SUBSCRIPTION_REQUIRED"
    APPLE_MUSIC_AUTH_RUNTIME_UNAVAILABLE = "APPLE_MUSIC_AUTH_RUNTIME_UNAVAILABLE"
    APPLE_MUSIC_AUTH_PERSIST_FAILED = "APPLE_MUSIC_AUTH_PERSIST_FAILED"
    APPLE_MUSIC_AUTH_RELOAD_FAILED = "APPLE_MUSIC_AUTH_RELOAD_FAILED"
    APPLE_MUSIC_AUTH_MESSAGE_DELETE_FAILED = "APPLE_MUSIC_AUTH_MESSAGE_DELETE_FAILED"
    DISCONNECT_UNSUPPORTED = "DISCONNECT_UNSUPPORTED"
    DISCONNECT_FAILED = "DISCONNECT_FAILED"
    CREDENTIAL_EXPIRED = "CREDENTIAL_EXPIRED"
    CREDENTIAL_INVALID = "CREDENTIAL_INVALID"
    CREDENTIAL_REVOKED = "CREDENTIAL_REVOKED"
    LIFECYCLE_RECONCILIATION_FAILED = "LIFECYCLE_RECONCILIATION_FAILED"
...
class ProviderAuthorizationMethod(StrEnum):
    ...
    APPLE_MUSIC_SESSION_TOKEN = "APPLE_MUSIC_SESSION_TOKEN"
...
@dataclass(frozen=True, slots=True)
class ProviderSessionTokenInput:
    """Opaque user session token handed directly to an isolated provider."""
...
@dataclass(frozen=True, slots=True)
class ProviderQobuzCredentialInput:
    """Opaque Qobuz email/password pair handed directly to the child runtime."""
